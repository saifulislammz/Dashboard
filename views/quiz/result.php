...
<div class="w-full max-w-[420px]">
    ...
    <div class="bg-white rounded-[32px] shadow-sm border border-gray-100 slide-up relative pt-16 pb-8 px-6 text-center mt-12">
        ...
        <!-- Large Score text -->
        <div class="mb-4 flex justify-center items-baseline gap-2 text-[#0f5132] font-black tracking-tight" style="font-size: 3.5rem; line-height: 1;">
        ...
        <div class="inline-flex items-center bg-[#eefcf2] text-[#0f5132] px-5 py-2 rounded-full text-sm font-bold mb-8 border border-[#d1f4e0]">
