            ...
            <form action="/change_password.php" method="POST" class="space-y-6 max-w-full">
                ...
                <div class="space-y-1" x-data="{ show: false }">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input :type="show ? 'text' : 'password'" name="current_password" required placeholder="Enter your current password" class="block w-full pl-10 pr-10 border-gray-300 border focus:ring-primary focus:border-primary sm:text-sm rounded-lg py-2.5">
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" @click="show = !show">
                            <!-- Eye icon (shown when password is text) -->
                            ...
                            <!-- Eye-slash icon (shown when password is hidden) -->
                ...
                <div class="space-y-1" x-data="{ show: false }">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input :type="show ? 'text' : 'password'" name="new_password" required placeholder="Enter your new password" class="block w-full pl-10 pr-10 border-gray-300 border focus:ring-primary focus:border-primary sm:text-sm rounded-lg py-2.5">
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" @click="show = !show">
                            <!-- Eye icon (shown when password is text) -->
                            <svg x-show="show" x-cloak class="h-5 w-5 text-gray-400 hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                ...
                <div class="space-y-1" x-data="{ show: false }">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input :type="show ? 'text' : 'password'" name="confirm_password" required placeholder="Confirm your new password" class="block w-full pl-10 pr-10 border-gray-300 border focus:ring-primary focus:border-primary sm:text-sm rounded-lg py-2.5">
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer" @click="show = !show">
                            <!-- Eye icon (shown when password is text) -->
                            <svg x-show="show" x-cloak class="h-5 w-5 text-gray-400 hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
