                            ...
                            <li class="px-6 py-3 flex items-center justify-between gap-3 hover:bg-gray-50 transition-colors">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-xs text-gray-400 truncate"><?= htmlspecialchars($p['email'] ?? '', ENT_QUOTES, 'UTF-8') ?></p>
                                    </div>
                                </div>
                        ...
                        <?php foreach ($absent as $a): ?>
                            <li class="px-6 py-3 flex items-center gap-3 hover:bg-gray-50 transition-colors">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-gray-400 truncate"><?= htmlspecialchars($a['email'] ?? '', ENT_QUOTES, 'UTF-8') ?></p>
                                </div>
                            </li>
                        <?php endforeach; ?>
                    </ul>
