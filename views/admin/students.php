...
<main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-[#f8fafc]">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div id="createForm" class="hidden bg-white shadow-sm border border-gray-100 rounded-xl p-6">
            <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Fill in the details below to add a new student.</p>
                </div>
            </div>
            
            <form action="students.php?action=create" method="POST" class="space-y-6">
        ...
        <div class="bg-white p-2 rounded-xl shadow-sm border border-gray-100 flex items-center gap-2">
            <form action="students.php" method="GET" class="flex w-full gap-2 items-center">
        ...
        <div class="bg-white shadow-sm border border-gray-100 rounded-xl overflow-hidden">
                    ...
                    <tbody class="bg-white divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-4">
                                <!-- Status Toggle -->
                                <form action="students.php?action=status" method="POST" class="inline">
                                    <input type="hidden" name="csrf_token" value="<?php echo e(generateCsrfToken()); ?>">
                                ...
                                <!-- Delete -->
                                <form action="students.php?action=delete" method="POST" class="inline" onsubmit="return confirm('Are you sure?');">
                                    <input type="hidden" name="csrf_token" value="<?php echo e(generateCsrfToken()); ?>">
                                    <input type="hidden" name="id" value="<?php echo $student['id']; ?>">
            ...
            <div class="bg-white px-4 py-3 border-t border-gray-100 flex items-center justify-between sm:px-6">
                <div class="flex-1 flex justify-between">
                    <?php if($page > 1): ?>
                        <a href="students.php?page=<?php echo $page-1; ?>&search=<?php echo urlencode($search); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-200 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors">Previous</a>
                    <?php endif; ?>
                    <?php if($page < $totalPages): ?>
                        <a href="students.php?page=<?php echo $page+1; ?>&search=<?php echo urlencode($search); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-200 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 ml-auto transition-colors">Next</a>
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
