    ...
    <div class="max-w-[1600px] mx-auto px-6 py-8 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-[#0f172a] leading-none"><?= htmlspecialchars((string) $statsTotal, ENT_QUOTES, 'UTF-8') ?></p>
                </div>
            </div>
            ...
            <?php else: ?>
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:col-span-<?= count($currencyTotals) > 1 ? '1' : '2' ?>">
            ...
            <div class="bg-gradient-to-br from-primary to-primary rounded-2xl shadow-sm p-6 flex items-center gap-5">
                ...
                <div>
                    <p class="text-xs font-bold text-white/70 uppercase tracking-wider mb-1"><?= count($currencyTotals) ?> Currencies</p>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
            <form method="GET" action="/admin/invoices/index.php" class="flex flex-wrap items-end gap-3">
                ...
                <div class="flex-1 min-w-[200px]">
                    <label class="block text-xs font-semibold text-[#94a3b8] mb-1.5 uppercase tracking-wider">Search</label>
                    <div class="relative">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div class="py-20 text-center text-[#94a3b8]">
                <svg class="w-16 h-16 mx-auto mb-4 opacity-20" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-gray-100 bg-gray-50/60">
                            <th class="text-left px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider">Invoice #</th>
                            <th class="text-left px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider">Student</th>
                            <th class="text-center px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider">Currency</th>
                            <th class="text-right px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider">Amount</th>
                            <th class="text-center px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider">Status</th>
                            <th class="text-center px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider hidden lg:table-cell">Invoice Date</th>
                            <th class="text-center px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider hidden lg:table-cell">Due Date</th>
                            <th class="text-center px-4 py-3 text-xs font-semibold text-[#94a3b8] uppercase tracking-wider">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50/80 transition-colors group">
                            ...
                            <td class="px-4 py-3.5">
                                ...
                                <?php if ($email): ?><p class="text-xs text-[#94a3b8] mt-0.5"><?= $email ?></p><?php endif; ?>
                            </td>
                            <!-- Currency Badge -->
                            ...
                            <!-- Amount -->
                            <td class="px-4 py-3.5 text-right font-semibold text-[#0f172a] font-mono"><?= $amount ?></td>
                            <!-- Status -->
            ...
            <div class="px-4 py-3 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
                ...
                <nav class="flex items-center gap-1" aria-label="Invoice pagination">
                    ...
                    <a href="<?= pageUrl($currentPage - 1) ?>" class="w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 text-[#64748b] hover:bg-gray-50 transition-colors text-sm">
