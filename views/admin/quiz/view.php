...
<div class="max-w-[1400px] mx-auto px-6 py-8 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-[#64748b] mt-0.5">কুইজ রিপোর্ট ও অংশগ্রহণকারীদের বিবরণ</p>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <a href="/admin/quiz/edit.php?id=<?php echo $quizId; ?>"
               class="px-4 py-2 text-sm font-medium bg-amber-50 text-amber-700 rounded-xl hover:bg-amber-100 transition-colors">সম্পাদনা</a>
        </div>
    </div>
    ...
    <div class="flex items-center gap-3 p-4 bg-white border border-gray-100 rounded-2xl shadow-sm">
        ...
        <span class="text-sm text-[#64748b] font-medium flex-shrink-0">Public লিংক:</span>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-sm font-medium text-[#64748b]">মোট অংশগ্রহণকারী</span>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-sm font-medium text-[#64748b]">সম্পূর্ণ করেছে</span>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-sm font-medium text-[#64748b]">অর্ধেকে ছেড়েছে</span>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-5">
            <div class="flex items-center gap-3 mb-3">
                ...
                <span class="text-sm font-medium text-[#64748b]">অপঠিত ভয়েস</span>
            </div>
    ...
    <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="font-semibold text-[#1e293b]">অংশগ্রহণকারীদের তালিকা</h2>
        </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-[#f8fafc] border-b border-gray-100">
                        ...
                        <th class="px-4 py-3 text-left font-semibold text-[#64748b]">নাম</th>
                        <th class="px-4 py-3 text-left font-semibold text-[#64748b]">WhatsApp</th>
                        <th class="px-4 py-3 text-left font-semibold text-[#64748b]">তারিখ</th>
                        <th class="px-4 py-3 text-center font-semibold text-[#64748b]">সঠিক</th>
                        <th class="px-4 py-3 text-center font-semibold text-[#64748b]">ভুল</th>
                        <th class="px-4 py-3 text-center font-semibold text-[#64748b]">স্কোর</th>
                        <th class="px-4 py-3 text-center font-semibold text-[#64748b]">ভয়েস</th>
                        <th class="px-4 py-3 text-left font-semibold text-[#64748b]">রিভিউ নোট</th>
                    </tr>
                </thead>
                ...
                <?php foreach ($attempts as $i => $a): ?>
                    <tr class="hover:bg-[#f8fafc] transition-colors" x-data="voiceReview(<?php echo (int)$a['id']; ?>, <?php echo json_encode($a['voice_note'] ?? ''); ?>)">
                        ...
                        <td class="px-4 py-3">
                            ...
                            <div class="text-xs text-[#64748b]"><?php echo $a['gender'] === 'male' ? 'পুরুষ' : 'মহিলা'; ?></div>
                        </td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3 min-w-[220px]">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-2">
                                    <button @click="saveNote()"
                                        ...
                                        <span x-text="saving ? 'সংরক্ষণ...' : 'সেভ'"></span>
                                    </button>
                                    <span x-show="saved" x-transition class="text-xs text-[#059669] font-medium">✓ সংরক্ষিত</span>
                                    <!-- WhatsApp link -->
                            ...
                            <?php else: ?>
                                <span class="text-xs text-gray-400">ভয়েস জমা দেননি</span>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        ...
        <div class="flex items-center justify-between px-6 py-4 border-t border-gray-100">
            <p class="text-sm text-[#64748b]">মোট <strong><?php echo $total; ?></strong> জন</p>
    ...
    return {
        ...
        async saveNote() {
            ...
            try {
                ...
                else alert(d.message || 'সংরক্ষণ ব্যর্থ।');
