...
<main class="flex-1 overflow-y-auto bg-[#fafafa]">
    <div class="max-w-[1400px] mx-auto px-6 py-8 space-y-6">
        ...
        <?php if (isset($_GET['deleted'])): ?>
            <div
                class="flex items-center gap-3 px-4 py-3 bg-red-50 border border-red-200 rounded-xl text-red-700 text-sm font-medium">
        ...
        <form method="GET" action="/admin/quiz/index.php"
            ...
            <select name="status"
                ...
                <option value="active" <?php echo ($_GET['status'] ?? '') === 'active' ? 'selected' : ''; ?>>Active
                </option>
                <option value="inactive" <?php echo ($_GET['status'] ?? '') === 'inactive' ? 'selected' : ''; ?>>Inactive
                </option>
            </select>
            <button type="submit"
                                ...
                                <tr class="hover:bg-[#f8fafc] transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <?php if ($q['status'] === 'active'): ?>
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700">Active</span>
                                        <?php else: ?>
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-500">Inactive</span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <?php if ((int) $q['unreviewed_count'] > 0): ?>
                                            <span
                                                class="inline-flex items-center justify-center w-6 h-6 bg-red-500 text-white text-xs font-bold rounded-full">
