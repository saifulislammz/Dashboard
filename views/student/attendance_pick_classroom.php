...
<main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-gray-50">
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Select a classroom to view your attendance report</p>
        </div>
        ...
        <?php else: ?>
            <div class="grid gap-4">
                ...
                <a href="/student/attendance.php?classroom_id=<?= (int) $cr['id'] ?>"
                   class="flex items-center justify-between bg-white rounded-xl shadow-sm border border-gray-100 px-6 py-5 hover:border-primary hover:shadow-md transition-all group">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 mt-0.5">
                            ...
                            <?php if (!empty($cr['teacher_name'])): ?>
                                &middot; Teacher: <?= htmlspecialchars($cr['teacher_name'], ENT_QUOTES, 'UTF-8') ?>
                            <?php endif; ?>
                        </p>
                    </div>
