...
<aside id="sidebar"
    ...
    <div
        ...
        <a href="/student/sessions.php"
            class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors <?php echo ($activeMenu ?? '') === 'student_sessions' ? 'text-primary font-bold bg-primary/5' : 'text-gray-600 hover:bg-gray-50 hover:text-primary font-medium'; ?>">
            <i class="ph ph-video-camera text-xl"></i>
            <span class="text-sm">Live Classes</span>
        </a>

        <a href="/student/attendance.php<?php echo isset($classroom) ? '?classroom_id=' . (int) $classroom['id'] : ''; ?>"
            class="flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors <?php echo ($activeMenu ?? '') === 'student_attendance' ? 'text-primary font-bold bg-primary/5' : 'text-gray-600 hover:bg-gray-50 hover:text-primary font-medium'; ?>">
