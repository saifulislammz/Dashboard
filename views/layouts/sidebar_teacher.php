...
<!-- Sidebar -->
<aside id="teacher-sidebar" class="
...
">
    ...
    <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="/teacher/sessions.php"
            class="<?php echo ($activeMenu ?? '') === 'teacher_sessions' ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'; ?> group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors"
            onclick="closeTeacherSidebar()">
            <svg class="mr-3 flex-shrink-0 h-6 w-6 transition-colors" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/teacher/attendance.php?classroom_id=<?php echo isset($classroom) ? (int)$classroom['id'] : ''; ?>"
            class="<?php echo ($activeMenu ?? '') === 'teacher_attendance' ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'; ?> group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors"
            onclick="closeTeacherSidebar()">
            <svg class="mr-3 flex-shrink-0 h-6 w-6 transition-colors" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
