...
<main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-gray-50">
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="/teacher/classrooms.php" class="text-sm font-medium text-primary hover:text-primary/80 transition-colors">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-8 sm:p-10 -mt-12">
                ...
                <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Assigned Student Name</dt>
                        <dd class="mt-1 text-sm text-gray-900"><?= htmlspecialchars($classroom['student_name'] ?? 'N/A') ?></dd>
                    </div>

                    <div class="sm:col-span-1">
                        <dt class="text-sm font-medium text-gray-500">Assigned Student Email</dt>
                        <dd class="mt-1 text-sm text-gray-900"><?= htmlspecialchars($classroom['student_email'] ?? 'N/A') ?></dd>
                    </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <p class="text-sm text-gray-500 italic">
                        Note: Teachers can view classroom details but cannot modify assignments. Contact the Administrator for changes.
                    </p>
                </div>
            </div>
        </div>
