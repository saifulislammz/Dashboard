        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <?php if ($classroomId > 0): ?>
                    <p class="text-sm text-gray-500 mt-1">Manage and launch live sessions for this classroom.</p>
                <?php else: ?>
                    <p class="text-sm text-gray-500 mt-1">Your schedule for upcoming live classes.</p>
                <?php endif; ?>
            </div>
            <?php if ($classroomId > 0): ?>
                <a href="/teacher/classrooms/view.php?id=<?= $classroomId ?>" class="text-sm font-medium text-primary hover:text-primary/80 transition-colors">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <?php if ($classroomId === 0): ?>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Classroom</th>
                            <?php endif; ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td colspan="<?= $classroomId === 0 ? '5' : '4' ?>" class="px-6 py-10 text-center text-gray-500">
                        ...
                        <?php else: ?>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <?php if ($classroomId === 0): ?>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?= htmlspecialchars($session['class_name']) ?></div>
                                    </td>
                                <?php endif; ?>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    <?php else: ?>
                                        <span class="text-xs text-gray-400">Link Pending</span>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
